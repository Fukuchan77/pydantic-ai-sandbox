"""Anthropic direct-API provider builder — MVP stub (plan.md §2.4 / Req 2.4).
...
__all__ = ["_build_anthropic"]


def _build_anthropic(settings: Settings) -> Never:
    ...
    """
    del settings
    msg = "Provider 'anthropic' is not implemented in MVP; tracked in 002-multi-provider"
